package br.com.link_box_core_back_springboot.modules.login.annotations;
...
@Operation(summary = "Autenticação do usuário", description = "Autentica o usuário no sistema")
public @interface LoginSwaggerConfig {
}
