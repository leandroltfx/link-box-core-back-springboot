...
@ApiResponses({
        @ApiResponse(responseCode = "200", content = {
                @Content(schema = @Schema(implementation = UpdateCollectionResponseDTO.class))
        }),
...
@Operation(summary = "Alteração de coleção", description = "Altera nome e/ou descrição de uma coleção")
public @interface UpdateCollectionSwaggerConfig {
}
